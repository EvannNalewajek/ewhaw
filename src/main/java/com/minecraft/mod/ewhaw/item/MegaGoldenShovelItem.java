...
public class MegaGoldenShovelItem extends ShovelItem {
    private static final ThreadLocal<Boolean> MINING_ZONE = ThreadLocal.withInitial(() -> false);

    public MegaGoldenShovelItem(Tier tier, Properties properties) {
    ...
    public boolean mineBlock(ItemStack stack, Level level, BlockState state, BlockPos pos, LivingEntity entity) {
        ...
        if (!level.isClientSide && entity instanceof Player player) {
            try {
                ...
                // On réduit un peu les dégâts auto (passant de 248 à 50 pour laisser une chance à la durabilité)
    ...
    private void mineHugeArea(ItemStack stack, Level level, BlockState originState, BlockPos originPos, Player player) {
        ...
        // Réduit à une profondeur de 5 et un rayon de 2 (zone 5x5x5)
